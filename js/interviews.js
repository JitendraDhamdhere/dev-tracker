...
(function () {
  const InterviewsModule = {
    ...
    renderInterviews: function () {
      ...
      const interviews = StorageService.get('interviews') || [];
    ...
    saveInterview: function () {
      ...
      StorageService.set('interviews', interviews);
    ...
    editInterviewPrompt: function (id) {
      const interviews = StorageService.get('interviews') || [];
    ...
    deleteInterview: function (id) {
      ...
      StorageService.set('interviews', filtered);
