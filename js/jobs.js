...
(function () {
  const JobsModule = {
    ...
    initEventListeners: function () {
      ...
      if (searchBox) searchBox.addEventListener('input', () => this.renderJobsGrid());
      if (filterStatus) filterStatus.addEventListener('change', () => this.renderJobsGrid());
      if (filterPrio) filterPrio.addEventListener('change', () => this.renderJobsGrid());
    },
    ...
    deleteJob: function (id) {
      ...
      StorageService.set('jobs', filtered);
