...
(function () {
  const ProjectsModule = {
    ...
    saveProject: function () {
      ...
      StorageService.set('projects', projects);
      App.closeModal('modal-project-editor');
      this.render();
    },

    editProjectPrompt: function (id) {
      const projects = StorageService.get('projects') || [];
    ...
    addProjectTask: function (projId) {
