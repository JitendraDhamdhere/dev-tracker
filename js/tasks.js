...
(function () {
  const TasksModule = {
    ...
    initEventListeners: function () {
      ...
      if (addSubtaskBtn) {
        addSubtaskBtn.addEventListener('click', () => this.addSubtaskFromInput());
      }
    ...
    bindDragEvents: function (colList) {
